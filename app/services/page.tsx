...
const services = [
  { title: "SAP Consulting", href: "/services/sap-consulting", image: "/assets/image/S0201.jpg", imageAlt: "SAP consulting and implementation", description: "End-to-end SAP transformation and consulting that aligns consolidation, planning, forecasting, analytics, and profitability processes with business goals.", capabilities: ["Implementation strategy", "Configuration", "Planning and forecasting", "Analytics and reporting"] },
...
export default function ServicesPage() {
  return (
    <SectionLanding
      ...
      description="Trijotech provides end-to-end SAP services across implementation, support, integration, analytics, cloud, and intelligent technologies."
      heroImage="/assets/heroes/services.png"
      animateHero={false}
      cardsTitle={
        <>
          Expertise across your{" "}
          <span className="text-white">SAP journey</span>
        </>
      }
      cardsIntro="Explore our current services, each built from practical delivery experience and linked to its full service detail."
      cards={services}
      showCardIcons
      cardLayout="rows"
    />
