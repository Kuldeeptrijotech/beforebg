...
export default function Page(){return <main className="legacy-service-source-page"><ServiceHero title="SAP Full-Stack Applications on BTP" image="/assets/image/Home3.png"/><OfferingGrid heading={<>Our Service <em>Offerings</em></>} intro="At Trijotech, our commitment doesn’t end with implementation. We ensure your SAP systems remain resilient, responsive, and aligned with your business objectives—every day. Our SAP Support & AMS (Application Management Services) are built to deliver operational continuity, performance assurance, and ongoing value from your SAP investments." cards={offerings}/><ImpactGrid cards={impacts}/><Results/><ContactButton/></main>}
