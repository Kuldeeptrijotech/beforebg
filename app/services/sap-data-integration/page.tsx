...
export const metadata: Metadata={title:"SAP Data Integration"};
const offerings=[
...
export default function Page(){return <main className="legacy-service-source-page"><ServiceHero title="SAP Data Integration" image="/assets/image/Home3.png"/><OfferingGrid heading={<>Our Service <em>Offerings</em></>} intro="At Trijotech, we help organizations connect and unify their data landscape. Our SAP data integration services bring together systems, applications, and data sources into a single, reliable foundation—enabling seamless operations, real-time insights, and smarter decision-making across the enterprise." cards={offerings}/><ImpactGrid cards={impacts}/><Results/><ContactButton/></main>}
