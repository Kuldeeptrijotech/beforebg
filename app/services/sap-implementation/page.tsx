...
export const metadata: Metadata = { title: "SAP Implementation Services", description: "Transforming businesses with expert SAP implementation solutions from Trijotech." };
