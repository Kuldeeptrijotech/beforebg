      ...
      <div className="relative">
        <div className="relative flex aspect-[16/9] w-full items-center justify-center overflow-hidden rounded-2xl bg-[#030713] border border-white/10 shadow-2xl">
          <Image
            ...
            loading="lazy"
          />
          <span className="absolute right-3.5 top-3.5 rounded-full border border-white/15 bg-[rgba(3,7,19,0.75)] px-3 py-1 text-xs font-semibold text-white shadow-lg backdrop-blur-md">
        ...
        {images.map((_, index) => (
          <button
            ...
            className={`rounded-full transition-all duration-300 ${
              index === current
                ? "h-2 w-6 bg-[linear-gradient(90deg,#22d3ee,#2563eb)] shadow-[0_0_6px_rgba(255, 255, 255,0.6)]"
