                    ...
                    <div className="col-md-12">
                        <div className="contact-form">
                            <form ref={formRef} id={`contact-${variant}`} onSubmit={handleSubmit} encType="multipart/form-data">
                                <div className="row">
                                    <div className="col-lg-6 col-md-12 col-sm-12"><fieldset><input name="name" type="text" className="form-control" placeholder="Full Name" minLength={2} maxLength={100} required /></fieldset></div>
                                    <div className="col-lg-6 col-md-12 col-sm-12"><fieldset><input name="email" type="email" className="form-control" placeholder="E-Mail Address" maxLength={254} required /></fieldset></div>
                                    <div className="col-lg-6 col-md-12 col-sm-12"><fieldset><input name="phone" type="tel" className="form-control" placeholder="Phone Number" pattern="[+0-9()\-\s]{7,25}" required /></fieldset></div>
                                    ...
                                    {showInquiryDropdown && <div className="col-lg-6 col-md-12 col-sm-12"><fieldset><select name="inquiryType" className="form-control" defaultValue="" required><option value="" disabled>Select Inquiry Type</option><option value="SAP Implementation">SAP Implementation</option><option value="SAP Support">SAP Support</option><option value="SAP BTP Full Stack Application">SAP BTP Full Stack Application</option><option value="Products">Products</option><option value="Careers">Careers</option><option value="Other">Other</option></select></fieldset></div>}

                                    {isCareer && <><div className="col-lg-6 col-md-12 col-sm-12"><fieldset><select name="position" className="form-control" defaultValue="" required><option value="" disabled>Select Position</option><option value="SAP Functional Consultant">SAP Functional Consultant</option><option value="SAP Technical Consultant">SAP Technical Consultant</option><option value="SAP Developer">SAP Developer</option><option value="Business Analyst">Business Analyst</option><option value="Other">Other</option></select></fieldset></div><div className="col-lg-6 col-md-12 col-sm-12"><fieldset><input name="experience" type="number" className="form-control" placeholder="Years of Experience" min="0" max="60" step="0.5" required /></fieldset></div><div className="col-lg-6 col-md-12 col-sm-12"><fieldset><input name="company" type="text" className="form-control" placeholder="Current Company (Optional)" maxLength={120} /></fieldset></div></>}
