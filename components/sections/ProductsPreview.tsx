          ...
          {visibleProducts.map((product, i) => {
            ...
            return (
              <StaggerRevealItem key={product.title} className="h-full">
                <Link
                  href={product.href}
                  className="tri-focus group flex h-full flex-col overflow-hidden rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-xl transition-all duration-300 hover:border-white/60 hover:bg-white/[0.06] hover:shadow-[0_16px_40px_rgba(255, 255, 255,0.18)]"
                >
