...
const KPIS = [
  { value: "94.6%", label: "Melting Yield Efficiency", color: "#ffffff" },
  { value: "99.98%", label: "Steel Metallurgy Purity", color: "#ffffff" },
  { value: "0 LTI", label: "Incident-Free Safety Record", color: "#ffffff" },
];
      ...
      <div className="relative h-full w-full overflow-hidden select-none">
        ...
        >
          ...
          {[260, 420, 580, 720, 860, 1020, 1180].map((x) => (
            <g key={x} opacity="0.45">
              <circle cx={x} cy={445} r="16" stroke="#ffffff" strokeWidth="2" fill="#030713" />
              <circle cx={x} cy={475} r="16" stroke="#ffffff" strokeWidth="2" fill="#030713" />
              <line x1={x - 10} y1={460} x2={x + 10} y2={460} stroke="#ffffff" strokeWidth="3" />
            </g>
          ))}

          {/* Flowing Molten Ember Packets */}
          <circle r="7" fill="#ffffff" filter="url(#steelGlow)">
            <animateMotion
              dur="7s"
          ...
          <circle r="5.5" fill="#ffffff" filter="url(#steelGlow)">
            <animateMotion
              dur="7s"
              begin="3.5s"
              repeatCount="indefinite"
          ...
          <div className="rounded-2xl border border-white/10 bg-[#030713]/85 p-4 shadow-2xl backdrop-blur-xl">
            <div className="flex items-center justify-between border-b border-white/10 pb-3">
              <div className="flex items-center gap-2">
                <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-white/15 border border-white/40 text-white">
              ...
              <span className="flex items-center gap-1 text-[9px] font-mono font-bold text-white" suppressHydrationWarning>
            ...
            <div className="mt-3 space-y-2">
              <div className="rounded-lg bg-white/[0.03] border border-white/5 p-2.5">
                <div className="flex items-center justify-between text-xs">
                  ...
                  <span className="font-mono font-bold text-white">94.6% [OPTIMAL]</span>
                </div>
                <div className="mt-1 h-1.5 w-full rounded-full bg-white/10 overflow-hidden">
                  <div className="h-full w-[94.6%] bg-gradient-to-r from-white/40 to-[#ffffff]" />
                </div>
              </div>
              <div className="flex items-center justify-between text-[10px] text-white/70 px-1">
                <span>Power: 84.2 MW</span>
                <span className="font-semibold text-white">Zero Energy Spikes</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="absolute left-1/2 top-[12%] -translate-x-1/2 z-20 flex flex-col items-center">
          <motion.div
            ...
            className="relative flex h-24 w-24 items-center justify-center rounded-3xl border border-white/50 bg-gradient-to-br from-white/30 via-[#030713] to-[#ffffff]/40 shadow-[0_0_60px_rgba(255,255,255,0.4)] backdrop-blur-xl"
          >
            <Factory className="h-12 w-12 text-white drop-shadow-[0_0_15px_#ffffff]" />
          </motion.div>
          ...
          <div className="rounded-2xl border border-white/10 bg-[#030713]/85 p-4 shadow-2xl backdrop-blur-xl">
            ...
            <div className="mt-3 space-y-2 text-xs">
              <div className="flex items-center justify-between text-white/80">
                ...
                <span className="font-mono font-bold text-white">99.98% GRADE A+</span>
              </div>
              <div className="flex items-center justify-between text-white/80">
                <span>Plant Safety Record</span>
                <span className="font-bold text-white">0 LTI (Zero Harm)</span>
              </div>
