  ...
  const heroCopy = (
    <>
      <motion.div
        ...
        className="mb-7 inline-flex items-center gap-2.5 rounded-full border border-white/14 bg-white/[0.06] px-5 py-2.5 text-xs font-semibold uppercase tracking-[0.26em] text-[#7edcc2] backdrop-blur-xl"
      >
      ...
      <motion.h1
        ...
        className="text-4xl font-extrabold leading-[1.05] tracking-tight text-white sm:text-5xl lg:text-6xl xl:text-7xl"
      >
        {title}
      </motion.h1>
  ...
  return (
    <main className="overflow-hidden bg-[#030713] text-white">
      ...
      >
        ...
        <div className="pointer-events-none absolute right-[8%] top-[12%] -z-10 h-80 w-80 rounded-full bg-[rgba(41,171,135,0.14)] blur-[80px] animate-float-slow" />
        <div className="pointer-events-none absolute bottom-[18%] left-[4%] -z-10 h-60 w-60 rounded-full bg-[rgba(245,166,35,0.10)] blur-[70px] animate-float-reverse" />
        ...
        {heroLayout !== "centered" ? (
            ...
            <div className="grid w-full items-center gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.35fr)] lg:gap-14">
              ...
              <div className="relative order-2 hidden min-h-[360px] sm:min-h-[440px] lg:block lg:min-h-[600px]">
                {scene ? (
                  ...
                  <div className="absolute inset-0 overflow-hidden rounded-[2.5rem] shadow-[0_32px_80px_-20px_rgba(41,171,135,0.3)]">
                    <Image src={heroImage} alt="" fill priority sizes="(max-width:1024px) 100vw, 50vw" className="object-cover object-center opacity-55" />
                    <div className="absolute inset-0 bg-[linear-gradient(160deg,rgba(41,171,135,0.18),transparent_55%)]" />
                    ...
                    <div className="absolute inset-0 rounded-[2.5rem] ring-1 ring-inset ring-[rgba(41,171,135,0.2)]" />
                  </div>
                )}
              </div>
            </div>
          ...
          /* centered: full-bleed scene behind centered text */
          <>
            {scene ? (
              <div className="absolute inset-0 top-[4.5rem]">{scene}</div>
            ) : (
        ...
        {heroLayout === "process" && steps.length > 0 && (
          <div className="relative border-t border-white/[0.07] bg-[#050817]/80 backdrop-blur-md">
            <div className="mx-auto flex max-w-7xl flex-wrap items-center gap-x-8 gap-y-4 px-5 py-6 sm:px-8 lg:px-12">
              <span className="inline-flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.24em] text-[#7edcc2]">
                <span className="h-1.5 w-1.5 rounded-full bg-[#29ab87] animate-pulse" /> Process
              </span>
                ...
                {steps.map((step, i) => (
                  <div key={step.label} className="flex items-center gap-x-2">
                    <div className="flex items-center gap-2.5 rounded-full border border-white/[0.09] bg-white/[0.05] px-4 py-2 backdrop-blur-sm">
                      <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[linear-gradient(150deg,#29ab87,#117a4b)] text-[10px] font-bold text-white">
                        {i + 1}
                      </span>
      ...
      <section className="relative overflow-hidden bg-[#0a1628] py-24 sm:py-32">
        ...
        <div aria-hidden className="pointer-events-none absolute -left-32 top-1/2 h-96 w-96 -translate-y-1/2 rounded-full bg-[rgba(41,171,135,0.07)] blur-[80px]" />
        ...
        <div className="relative mx-auto grid max-w-7xl gap-12 px-5 sm:px-8 lg:grid-cols-[.85fr_1.15fr] lg:items-center lg:px-12">
          ...
          <motion.div
            ...
            className="tri-glass-card rounded-3xl p-8 sm:p-10"
          >
            ...
            <div className="mt-8 flex items-center gap-3.5 border-t border-white/[0.08] pt-7">
              <motion.span
                ...
                className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[linear-gradient(135deg,#29ab87,#117a4b)] text-white shadow-[0_4px_16px_rgba(41,171,135,0.4)]"
              >
                <Check className="h-4 w-4" strokeWidth={2.5} />
              </motion.span>
              <span className="text-sm font-semibold text-[#7edcc2]">Practical delivery, measurable outcomes</span>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="relative overflow-hidden bg-[#06101e] py-24 sm:py-32">
        ...
        <div aria-hidden className="pointer-events-none absolute left-1/2 top-0 h-px w-3/4 -translate-x-1/2 bg-gradient-to-r from-transparent via-[rgba(41,171,135,0.35)] to-transparent" />
        <div aria-hidden className="pointer-events-none absolute -right-28 bottom-0 h-[500px] w-[500px] rounded-full bg-[rgba(245,166,35,0.07)] blur-[100px]" />
          ...
          <div className="mt-14 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            {offerings.map((item, index) => (
              ...
              >
                ...
                <div className="absolute inset-0 rounded-3xl bg-[linear-gradient(160deg,rgba(41,171,135,0.12),transparent_55%)] opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
                {/* Inner top highlight */}
                ...
                <div className="relative z-10 flex h-full flex-col p-7 sm:p-8">
                  ...
                  <motion.div
                    ...
                    className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[linear-gradient(150deg,rgba(41,171,135,0.2),rgba(17,122,75,0.15))] text-sm font-extrabold text-[#29ab87] ring-1 ring-[rgba(41,171,135,0.3)] transition-all duration-300 group-hover:bg-[linear-gradient(150deg,#29ab87,#117a4b)] group-hover:text-white group-hover:shadow-[0_8px_24px_rgba(41,171,135,0.4)] group-hover:ring-transparent"
                  >
                    {String(index + 1).padStart(2, "0")}
                  </motion.div>

                  {/* Accent underline */}
                  <div className="mt-5 h-px w-8 bg-[linear-gradient(90deg,#29ab87,#f5a623)] opacity-50 transition-all duration-400 group-hover:w-14 group-hover:opacity-100" />

                  <h3 className="relative mt-5 text-xl font-bold leading-snug text-white transition-colors group-hover:text-[#7edcc2] sm:text-[1.3rem]">
                    {item.title}
                  </h3>
        ...
        <div className="relative mx-auto grid w-full max-w-7xl items-center gap-12 px-5 sm:px-8 lg:grid-cols-2 lg:gap-16 lg:px-12">
          ...
          >
            ...
            <div className="absolute bottom-0 p-8 text-white sm:p-10">
              <p className="text-xs font-bold uppercase tracking-[0.22em] text-[#7edcc2]">Business value</p>
            ...
            <div className="mt-8 grid gap-4">
              {impacts.map((item, i) => (
                <motion.div
                  ...
                  className="group relative overflow-hidden rounded-2xl border border-white/[0.07] bg-[linear-gradient(160deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02))] p-5 backdrop-blur-sm transition-all duration-300 hover:border-[rgba(41,171,135,0.3)] hover:bg-[linear-gradient(160deg,rgba(41,171,135,0.1),rgba(255,255,255,0.03))]"
                >
                  <div className="flex items-start gap-4">
                    <span className="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[linear-gradient(135deg,#29ab87,#117a4b)] text-white shadow-[0_4px_12px_rgba(41,171,135,0.35)] transition-shadow duration-300 group-hover:shadow-[0_6px_20px_rgba(41,171,135,0.5)]">
                      <Check className="h-3.5 w-3.5" strokeWidth={2.5} />
                    </span>
                    <div className="min-w-0">
                      <h3 className="font-bold text-white group-hover:text-[#7edcc2] transition-colors">{item.title}</h3>
