  ...
  return (
    <div className={`relative mx-auto aspect-square w-full max-w-[380px] sm:max-w-[420px] lg:max-w-[460px] ${className}`}>
      ...
      <div
        ...
        style={{ background: "radial-gradient(circle, rgba(56, 189, 248, 0.35), rgba(34, 211, 238, 0.15) 50%, transparent 75%)" }}
      />
        ...
        <div className="relative flex items-center justify-center">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <motion.div
              ...
              className="flex h-12 w-12 items-center justify-center rounded-xl bg-[linear-gradient(150deg,#22d3ee,#0284c7_50%,#1d4ed8)] shadow-[0_0_35px_rgba(34,211,238,0.7)] border border-white/40 cursor-pointer"
            >
            ...
            <motion.div
              ...
              className={`group flex flex-col items-center gap-1.5 rounded-2xl border px-3 py-2 sm:px-3.5 sm:py-2.5 backdrop-blur-xl shadow-lg transition-all duration-300 ${
                node.tone === "amber"
                  ...
                  : "border-blue-400/40 bg-slate-900/80 hover:border-blue-300 hover:bg-slate-900/95 hover:shadow-[0_8px_25px_rgba(56,189,248,0.35)]"
              }`}
            >
              <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-white/10 text-cyan-300 transition-colors group-hover:bg-white group-hover:text-slate-900">
