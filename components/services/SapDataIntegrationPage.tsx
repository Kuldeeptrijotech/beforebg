...
import IntegrationDataRiver from "@/components/scenes/IntegrationDataRiver";
              ...
              {SOURCES.map((s) => {
                ...
                return (
                  <StaggerRevealItem key={s.label} variant="fadeIn">
                    <div className="flex items-center gap-2.5 rounded-xl border border-white/10 bg-white/[0.04] px-3 py-3 backdrop-blur-sm">
        ...
        <Container>
          <Reveal className="max-w-2xl">
            ...
            <h2 className="mt-5 text-3xl font-extrabold tracking-tight text-white sm:text-5xl">
              From messy sources to <span className="bg-gradient-to-r from-[#29ab87] to-[#f5a623] bg-clip-text text-transparent">clean data</span>
            </h2>
          </Reveal>
            ...
            <div>
              <Reveal>
                ...
                <h2 className="mt-5 text-3xl font-extrabold tracking-tight sm:text-5xl">
                  Mapped once, <span className="bg-gradient-to-r from-[#29ab87] to-[#f5a623] bg-clip-text text-transparent">trusted everywhere</span>
                </h2>
            ...
            <Reveal delay={0.15}>
              <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-[#162032]/90 p-8 backdrop-blur-md">
                ...
                <div className="mt-6 space-y-3">
                  {[
                    { from: "Legacy ERP", to: "S/4HANA", status: "Validated", tone: "#29ab87" },
                    { from: "CRM export", to: "SAP Integration Suite", status: "Synchronized", tone: "#f5a623" },
                    { from: "Raw files", to: "HANA Cloud", status: "Cleansed", tone: "#29ab87" },
                    { from: "Master data", to: "MDM", status: "Harmonized", tone: "#117a4b" },
                  ].map((r, i) => (
                    <motion.div
                      key={r.from}
                    ...
                    >
                      <Layers className="h-4 w-4 shrink-0 text-[#29ab87]" />
                ...
                <div className="mt-6 flex items-center justify-center gap-3 rounded-xl border border-[#29ab87]/25 bg-[#29ab87]/[0.07] px-4 py-3">
                  <RefreshCw className="h-5 w-5 shrink-0 text-[#29ab87]" />
      ...
      <section className="relative bg-[#162032] py-20 sm:py-24">
        <Container>
          <Reveal className="max-w-2xl">
            ...
            <h2 className="mt-5 text-3xl font-extrabold tracking-tight text-white sm:text-5xl">
              Integration capabilities that <span className="bg-gradient-to-r from-[#29ab87] to-[#f5a623] bg-clip-text text-transparent">scale</span>
            </h2>
